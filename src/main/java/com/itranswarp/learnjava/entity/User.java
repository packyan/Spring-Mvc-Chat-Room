...
public class User {
	...
	//@JsonIgnore, json 完全忽略该属性，在pos和get 的时候都回忽略，例如注册的时候返回一个json也得不到。
...
/*	public long getCreatedAt() {
	...
	public String toString() {
		return String.format("User[id=%s, email=%s, name=%s, password=%s]", getId(),
				getEmail(), getName(), getPassword());
	}
}
